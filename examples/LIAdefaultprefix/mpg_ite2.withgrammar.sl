...
(constraint (iteB (>= (plus2 x y ) 1) (iteB (>= (plus2 x z ) 1) (= (__SYNTHFUN_eq1 x y z ) (+ x 1)) (= (__SYNTHFUN_eq1 x y z ) (+ y 1)) ) (iteB (>= (plus2 y z ) 1) (= (__SYNTHFUN_eq1 x y z ) (+ z 1)) (= (__SYNTHFUN_eq1 x y z ) (+ y 1)) ) ))
(check-synth)
