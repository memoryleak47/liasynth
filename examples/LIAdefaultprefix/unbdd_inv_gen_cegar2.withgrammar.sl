...
(synth-fun __SYNTHFUN_inv((x Int)(m Int)(n Int)) Bool
...
(constraint (=> (and (= x 0) (= m 0)) (__SYNTHFUN_inv x m n )))
(constraint (=> (and5 (__SYNTHFUN_inv x m n ) (< x n) (or (= m1 x) (= m1 m)) (= x1 (+ x 1)) (= n1 n) ) (__SYNTHFUN_inv x1 m1 n1 )))
(constraint (=> (and3 (__SYNTHFUN_inv x m n ) (>= x n) (> n 0) ) (and (<= 0 m) (< m n))))
(check-synth)
