...
(synth-fun __SYNTHFUN_move((currPoint Int)(o0 Int)(o1 Int)) Int
((NTInt Int)(NTbool Bool))
((NTInt Int (currPoint o0 o1 0 1 (- NTInt) (+ NTInt NTInt) (- NTInt NTInt) (ite NTbool NTInt NTInt) ))
(NTbool Bool ((not NTbool) (and NTbool NTbool) (or NTbool NTbool) (ite NTbool NTbool NTbool) (= NTInt NTInt) (< NTInt NTInt) (> NTInt NTInt) ))
)
)

(constraint (or (and (= (interpret-move (interpret-move (interpret-move 0 (__SYNTHFUN_move 0 99 98 ) ) (__SYNTHFUN_move (interpret-move 0 (__SYNTHFUN_move 0 99 98 ) ) o0-1 o1-1 ) ) (__SYNTHFUN_move (interpret-move (interpret-move 0 (__SYNTHFUN_move 0 99 98 ) ) (__SYNTHFUN_move (interpret-move 0 (__SYNTHFUN_move 0 99 98 ) ) o0-1 o1-1 ) ) o0-2 o1-2 ) ) 21) (and (no-overlaps-one-step 0 (__SYNTHFUN_move 0 99 98 ) 99 o0-1 98 o1-1 ) (and (no-overlaps-one-step (interpret-move 0 (__SYNTHFUN_move 0 99 98 ) ) (__SYNTHFUN_move (interpret-move 0 (__SYNTHFUN_move 0 99 98 ) ) o0-1 o1-1 ) o0-1 o0-2 o1-1 o1-2 ) (and (no-overlaps-one-step (interpret-move (interpret-move 0 (__SYNTHFUN_move 0 99 98 ) ) (__SYNTHFUN_move (interpret-move 0 (__SYNTHFUN_move 0 99 98 ) ) o0-1 o1-1 ) ) (__SYNTHFUN_move (interpret-move (interpret-move 0 (__SYNTHFUN_move 0 99 98 ) ) (__SYNTHFUN_move (interpret-move 0 (__SYNTHFUN_move 0 99 98 ) ) o0-1 o1-1 ) ) o0-2 o1-2 ) o0-2 o0-3 o1-2 o1-3 ) true)))) (not (and (allowable-move-obstacle-0 99 o0-1 ) (and (allowable-move-obstacle-0 o0-1 o0-2 ) (and (allowable-move-obstacle-0 o0-2 o0-3 ) (and (allowable-move-obstacle-1 98 o1-1 ) (and (allowable-move-obstacle-1 o1-1 o1-2 ) (and (allowable-move-obstacle-1 o1-2 o1-3 ) true)))))))))
(check-synth)
