...
(synth-fun __SYNTHFUN_inv((s Int)(i Int)) Bool
...
(constraint (=> (and (= s 0) (= i 1)) (__SYNTHFUN_inv s i )))
(constraint (=> (and4 (__SYNTHFUN_inv s i ) (<= i 8) (= s1 (+ s 1)) (= i1 (+ i 1)) ) (__SYNTHFUN_inv s1 i1 )))
(constraint (=> (and (__SYNTHFUN_inv s i ) (> i 8)) (or (= s 8) (= s 0))))
(check-synth)
