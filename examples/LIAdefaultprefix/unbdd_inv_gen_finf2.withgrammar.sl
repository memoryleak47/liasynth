...
(synth-fun __SYNTHFUN_inv((i Int)(x Int)(y Int)(n Int)) Bool
((NTbool Bool)(NTInt Int))
((NTbool Bool ((not NTbool) (and NTbool NTbool) (or NTbool NTbool) (ite NTbool NTbool NTbool) (= NTInt NTInt) (< NTInt NTInt) (> NTInt NTInt) ))
(NTInt Int (i x y n 0 1 (- NTInt) (+ NTInt NTInt) (- NTInt NTInt) (ite NTbool NTInt NTInt) ))
)
)

(constraint (=> (and5 (= i 0) (= x 0) (= y 0) (> n 0) (= i1 0) ) (__SYNTHFUN_inv i1 x y n )))
(constraint (=> (__SYNTHFUN_inv i x y n ) (= x 0)))
(constraint (=> (and (__SYNTHFUN_inv i x y n ) (= i1 (+ i 1))) (__SYNTHFUN_inv i1 x y n )))
(constraint (=> (and (__SYNTHFUN_inv i x y n ) false) (not (= x 0))))
(check-synth)
