...
(synth-fun __SYNTHFUN_inv((x Int)) Bool
...
(constraint (=> (= x 0) (__SYNTHFUN_inv x )))
(constraint (=> (__SYNTHFUN_inv x ) (= x 0)))
(constraint (=> (__SYNTHFUN_inv x ) (__SYNTHFUN_inv x )))
(constraint (=> (and (__SYNTHFUN_inv x ) false) (not (= x 0))))
(check-synth)
