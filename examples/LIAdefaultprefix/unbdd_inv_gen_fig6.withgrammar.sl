...
(synth-fun __SYNTHFUN_inv((y Int)) Bool
...
(constraint (=> true (__SYNTHFUN_inv y )))
(constraint (=> (and3 (__SYNTHFUN_inv y ) (> y 0) (= y1 (- y 1)) ) (__SYNTHFUN_inv y1 )))
(constraint (=> (and3 (__SYNTHFUN_inv y ) (<= y 0) false ) false))
(check-synth)
