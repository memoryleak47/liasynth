...
(NTInt Int (x n 0 1 (- NTInt) (+ NTInt NTInt) (- NTInt NTInt) (ite NTbool NTInt NTInt) ))
)
)

(constraint (=> (and (= x 0) (> n 0)) (__SYNTHFUN_inv x n )))
(constraint (=> (and false (__SYNTHFUN_inv x n )) (= x n)))
(constraint (=> (__SYNTHFUN_inv x n ) (__SYNTHFUN_inv x n )))
(constraint (=> (and3 (__SYNTHFUN_inv x n ) (= x1 (+ x 1)) (< x1 n) ) (__SYNTHFUN_inv x1 n )))
(constraint (=> (and3 (__SYNTHFUN_inv x n ) (= x1 (+ x 1)) (>= x1 n) ) (= x1 n)))
(check-synth)
