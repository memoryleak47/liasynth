...
(synth-fun __SYNTHFUN_inv((s Int)(i Int)(n Int)) Bool
((NTbool Bool)(NTInt Int))
((NTbool Bool ((not NTbool) (and NTbool NTbool) (or NTbool NTbool) (ite NTbool NTbool NTbool) (= NTInt NTInt) (< NTInt NTInt) (> NTInt NTInt) ))
(NTInt Int (s i n 0 1 (- NTInt) (+ NTInt NTInt) (- NTInt NTInt) (ite NTbool NTInt NTInt) ))
)
)

(constraint (=> (and (= s 0) (= i 1)) (__SYNTHFUN_inv s i n )))
(constraint (=> (and4 (__SYNTHFUN_inv s i n ) (<= i n) (= s1 (+ s 1)) (= i1 (+ i 1)) ) (__SYNTHFUN_inv s1 i1 n )))
(constraint (=> (and (__SYNTHFUN_inv s i n ) (> i n)) (or (= s n) (= s 0))))
(check-synth)
