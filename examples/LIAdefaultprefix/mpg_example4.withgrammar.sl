...
(synth-fun __SYNTHFUN_eq2((x Int)(y Int)(z Int)(z1 Int)) Int
((NTInt Int)(NTbool Bool))
((NTInt Int (x y z z1 0 1 (- NTInt) (+ NTInt NTInt) (- NTInt NTInt) (ite NTbool NTInt NTInt) ))
(NTbool Bool ((not NTbool) (and NTbool NTbool) (or NTbool NTbool) (ite NTbool NTbool NTbool) (= NTInt NTInt) (< NTInt NTInt) (> NTInt NTInt) ))
)
)

(constraint (iteB (>= (plus3 (two-times x ) z (minus z1 ) ) (minus y )) (iteB (<= (plus2 x z1 ) y) (= (__SYNTHFUN_eq2 x y z z1 ) (plus4 (ten-times x ) (two-times (ten-times y ) ) (three-times (five-times z ) ) (- 99) )) (= (__SYNTHFUN_eq2 x y z z1 ) (plus3 (nine-times y ) (five-times (five-times z1 ) ) (- 11) )) ) (iteB (<= (plus3 x (three-times z ) z1 ) (- 9)) (= (__SYNTHFUN_eq2 x y z z1 ) (plus5 (eleven-times x ) (five-times (three-times y ) ) (three-times (ten-times z ) ) (two-times (eleven-times z1 ) ) 11 )) (= (__SYNTHFUN_eq2 x y z z1 ) (plus4 (four-times (four-times x ) ) (three-times (six-times z ) ) (five-times z1 ) (- 55) )) ) ))
(check-synth)
