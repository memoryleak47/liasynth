...
(constraint (=> (= x 1) (__SYNTHFUN_inv x y )))
(constraint (=> (and5 (__SYNTHFUN_inv x y ) (<= x 10) (= y1 (- 10 x)) (not (or (< y1 0) (>= y1 10))) (= x1 (+ x 1)) ) (__SYNTHFUN_inv x1 y1 )))
(constraint (=> (and4 (__SYNTHFUN_inv x y ) (<= x 10) (= y1 (- 10 x)) (or (< y1 0) (>= y1 10)) ) false))
(check-synth)
