...
(constraint (iteB (<= (plus2 (two-times x ) (minus 3 ) ) (plus3 z (minus (two-times y ) ) 4 )) (>= (__SYNTHFUN_eq1 x y z ) x) (<= (__SYNTHFUN_eq1 x y z ) x) ))
(constraint (iteB (<= (plus2 (two-times x ) (minus 3 ) ) (plus3 z (minus (two-times y ) ) 4 )) (>= (__SYNTHFUN_eq1 x y z ) y) (<= (__SYNTHFUN_eq1 x y z ) y) ))
(constraint (iteB (<= (plus2 (two-times x ) (minus 3 ) ) (plus3 z (minus (two-times y ) ) 4 )) (>= (__SYNTHFUN_eq1 x y z ) z) (<= (__SYNTHFUN_eq1 x y z ) z) ))
(constraint (or3 (= (__SYNTHFUN_eq1 x y z ) x) (= (__SYNTHFUN_eq1 x y z ) y) (= (__SYNTHFUN_eq1 x y z ) z) ))
(check-synth)
