...
(synth-fun __SYNTHFUN_inv((i Int)(j Int)) Bool
((NTbool Bool)(NTInt Int))
((NTbool Bool ((not NTbool) (and NTbool NTbool) (or NTbool NTbool) (ite NTbool NTbool NTbool) (= NTInt NTInt) (< NTInt NTInt) (> NTInt NTInt) ))
(NTInt Int (i j 0 1 (- NTInt) (+ NTInt NTInt) (- NTInt NTInt) (ite NTbool NTInt NTInt) ))
)
)

(constraint (=> (= i 0) (__SYNTHFUN_inv i j )))
(constraint (=> (and5 (__SYNTHFUN_inv i j ) (<= 48 c) (<= c 57) (= j1 (- c 48)) (= i1 (+ (* 10 i) j1)) ) (__SYNTHFUN_inv i1 j1 )))
(constraint (=> (and (__SYNTHFUN_inv i j ) (not (and (<= 48 c) (<= c 57)))) (>= i 0)))
(check-synth)
