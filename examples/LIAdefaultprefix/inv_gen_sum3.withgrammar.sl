...
(synth-fun __SYNTHFUN_inv((s Int)(l Int)(n Int)(x Int)) Bool
((NTbool Bool)(NTInt Int))
((NTbool Bool ((not NTbool) (and NTbool NTbool) (or NTbool NTbool) (ite NTbool NTbool NTbool) (= NTInt NTInt) (< NTInt NTInt) (> NTInt NTInt) ))
(NTInt Int (s l n x 0 1 (- NTInt) (+ NTInt NTInt) (- NTInt NTInt) (ite NTbool NTInt NTInt) ))
)
)

(constraint (=> (and (= s 0) (= x 0)) (__SYNTHFUN_inv s l n x )))
(constraint (=> (and3 (__SYNTHFUN_inv s l n x ) (= s1 (+ s 1)) (= x1 (+ x 1)) ) (or (= s1 x1) (= s1 0))))
(constraint (=> (and3 (__SYNTHFUN_inv s l n x ) (= s1 (+ s 1)) (= x1 (+ x 1)) ) (__SYNTHFUN_inv s1 l n x1 )))
(check-synth)
