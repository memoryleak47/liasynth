...
(constraint (=> (and (and (and (and (and (and (= J4 (<= x!M0 0)) (= x!12 (+ 10 (* (- 2) x!M0)))) (=> (not J4) (= xPostExec x!12))) (not J4)) (= inB1 (<= inI0 0))) (= x!M0 (+ 10 (* (- 2) inI0)))) (not inB1)) (and (> (rankingFunction!0 x!M0 ) (rankingFunction!0 xPostExec )) (>= (rankingFunction!0 x!M0 ) 0))))
(check-synth)
