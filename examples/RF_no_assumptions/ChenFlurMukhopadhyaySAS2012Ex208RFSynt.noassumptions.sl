...
(constraint (=> (and (and (and (and (and (and (and (and (and (= J4 (<= x!M0 0)) (= x!12 (+ x!M0 (* (- 2) y!M0)))) (= y!18 (+ 1 y!M0))) (=> (not J4) (= xPostExec x!12))) (=> (not J4) (= yPostExec y!18))) (not J4)) (= inB3 (<= inI2 0))) (= x!M0 (+ inI2 (* (- 2) inI1)))) (= y!M0 (+ 1 inI1))) (not inB3)) (and (> (rankingFunction!0 x!M0 y!M0 ) (rankingFunction!0 xPostExec yPostExec )) (>= (rankingFunction!0 x!M0 y!M0 ) 0))))
(check-synth)
