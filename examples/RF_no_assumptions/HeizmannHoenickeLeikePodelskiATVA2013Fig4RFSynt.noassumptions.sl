...
(constraint (=> (and (and (and (and (and (= J9 (not (<= 23 x!M4))) (= x!15 (+ (- 1) x!M4))) (=> (not J9) (= xPostExec x!15))) (not J9)) (= inI0 23)) (= 23 yPostExec)) (and (> (rankingFunction!0 x!M4 23 ) (rankingFunction!0 xPostExec yPostExec )) (>= (rankingFunction!0 x!M4 23 ) 0))))
(check-synth)
