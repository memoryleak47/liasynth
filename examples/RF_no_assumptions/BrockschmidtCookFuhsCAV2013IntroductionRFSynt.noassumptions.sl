...
(constraint (=> (and (and (and (and (and (and (and (and (= J8 (<= x!M4 0)) (= x!14 (+ x!M4 (* (- 1) y!M4)))) (= y!20 (+ 1 y!M4))) (=> (not J8) (= xPostExec x!14))) (=> (not J8) (= yPostExec y!20))) (not J8)) (= inI0 1)) (> y!M4 0)) (>= y!M4 0)) (and (> (rankingFunction!0 x!M4 y!M4 ) (rankingFunction!0 xPostExec yPostExec )) (>= (rankingFunction!0 x!M4 y!M4 ) 0))))
(check-synth)
