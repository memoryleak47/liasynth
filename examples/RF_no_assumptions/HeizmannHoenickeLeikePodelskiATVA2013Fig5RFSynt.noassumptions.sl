...
(constraint (=> (and (and (and (and (and (and (and (and (= J8 (not (<= 0 x!M4))) (= x!14 (+ x!M4 (* (- 1) y!M4)))) (= y!22 (/ (+ 1 y!M4) 2))) (=> (not J8) (= xPostExec x!14))) (=> (not J8) (= yPostExec y!22))) (not J8)) (= inI0 2)) (> y!M4 0)) (>= y!M4 0)) (and (> (rankingFunction!0 x!M4 y!M4 ) (rankingFunction!0 xPostExec yPostExec )) (>= (rankingFunction!0 x!M4 y!M4 ) 0))))
(check-synth)
