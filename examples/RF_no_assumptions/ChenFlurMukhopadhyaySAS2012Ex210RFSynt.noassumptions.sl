...
(constraint (=> (and (and (and (and (and (and (and (and (and (and (and (= J4 (<= x!M0 0)) (= J6 (>= y!M0 0))) (= x!12 (+ x!M0 y!M0))) (= y!18 (+ (- 1) y!M0))) (=> (and (not J4) (not J6)) (= xPostExec x!12))) (=> (and (not J4) (not J6)) (= yPostExec y!18))) (and (not J4) (not J6))) (= inB3 (<= inI2 0))) (= inB5 (>= inI1 0))) (= x!M0 (+ inI2 inI1))) (= y!M0 (+ (- 1) inI1))) (and (not inB3) (not inB5))) (and (> (rankingFunction!0 x!M0 y!M0 ) (rankingFunction!0 xPostExec yPostExec )) (>= (rankingFunction!0 x!M0 y!M0 ) 0))))
(check-synth)
