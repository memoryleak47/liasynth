...
(constraint (=> (and (and (and (and (and (and (and (= J4 (not (<= 0 x!M0))) (= x!10 (+ x!M0 y!M0))) (= y!14 z!M0)) (= z!21 (+ (- 1) (* (- 1) z!M0)))) (=> (not J4) (= xPostExec x!10))) (=> (not J4) (= yPostExec y!14))) (=> (not J4) (= zPostExec z!21))) (not J4)) (and (> (rankingFunction!0 x!M0 y!M0 z!M0 ) (rankingFunction!0 xPostExec yPostExec zPostExec )) (>= (rankingFunction!0 x!M0 y!M0 z!M0 ) 0))))
(check-synth)
