...
(constraint (=> (and (and (and (and (and (and (and (and (and (and (= J7 (<= x!0 (+ y!M0 z!M0))) (= y!10 (+ 1 y!M0))) (= z!13 (+ 1 z!M0))) (=> (not J7) (= yPostExec y!10))) (=> (not J7) (= zPostExec z!13))) (not J7)) (= inB5 (<= x!0 (+ inI2 inI3)))) (= y!M0 (+ 1 inI2))) (= z!M0 (+ 1 inI3))) (not inB5)) (= x!0 xPostExec)) (and (> (rankingFunction!0 x!0 y!M0 z!M0 ) (rankingFunction!0 xPostExec yPostExec zPostExec )) (>= (rankingFunction!0 x!0 y!M0 z!M0 ) 0))))
(check-synth)
