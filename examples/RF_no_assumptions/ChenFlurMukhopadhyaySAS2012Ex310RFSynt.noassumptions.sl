...
(constraint (=> (and (and (and (and (and (and (and (= J4 (not (<= 0 x!M0))) (= J8 (not (<= 0 (+ x!M0 y!M0))))) (= x!16 (+ x!M0 y!M0 z!0))) (= y!23 (+ (- 1) (* (- 1) z!0)))) (=> (and (not J4) (not J8)) (= xPostExec x!16))) (=> (and (not J4) (not J8)) (= yPostExec y!23))) (and (not J4) (not J8))) (= z!0 zPostExec)) (and (> (rankingFunction!0 x!M0 y!M0 z!0 ) (rankingFunction!0 xPostExec yPostExec zPostExec )) (>= (rankingFunction!0 x!M0 y!M0 z!0 ) 0))))
(check-synth)
