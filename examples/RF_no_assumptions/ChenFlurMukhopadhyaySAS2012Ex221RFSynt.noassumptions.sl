...
(constraint (=> (and (and (and (and (and (and (and (and (and (= J4 (<= x!M0 0)) (= x!10 (+ x!M0 y!M0))) (= y!17 (+ (- 1) (* (- 1) y!M0)))) (=> (not J4) (= xPostExec x!10))) (=> (not J4) (= yPostExec y!17))) (not J4)) (= inB3 (<= inI2 0))) (= x!M0 (+ inI2 inI1))) (= y!M0 (+ (- 1) (* (- 1) inI1)))) (not inB3)) (and (> (rankingFunction!0 x!M0 y!M0 ) (rankingFunction!0 xPostExec yPostExec )) (>= (rankingFunction!0 x!M0 y!M0 ) 0))))
(check-synth)
