...
(constraint (=> (and (and (and (and (and (and (and (and (and (= J13 (<= (* (* 4 a!M4) a!M4) n!0)) (= J20 (not (<= (* (* 4 a!M4) a!M4) m!0)))) (= B3 (or J13 (and (not J13) (not J20))))) (= a!27 (+ 1 a!M4))) (=> B3 (= aPostExec a!27))) B3) (= inI0 0)) (>= a!M4 0)) (= n!0 nPostExec)) (= m!0 mPostExec)) (and (> (rankingFunction!0 n!0 m!0 a!M4 ) (rankingFunction!0 nPostExec mPostExec aPostExec )) (>= (rankingFunction!0 n!0 m!0 a!M4 ) 0))))
(check-synth)
