...
(constraint (=> (and (and (and (and (and (and (and (and (and (= J5 (<= x!M0 y!M0)) (= x!8 (+ (- 1) x!M0))) (= y!11 (+ 1 y!M0))) (=> (not J5) (= xPostExec x!8))) (=> (not J5) (= yPostExec y!11))) (not J5)) (= inB4 (<= inI3 inI2))) (= x!M0 (+ (- 1) inI3))) (= y!M0 (+ 1 inI2))) (not inB4)) (and (> (rankingFunction!0 x!M0 y!M0 ) (rankingFunction!0 xPostExec yPostExec )) (>= (rankingFunction!0 x!M0 y!M0 ) 0))))
(check-synth)
