...
(constraint (=> (and5 (= i 0) (= x 0) (= y 0) (> n 0) (= i1 0) ) (inv i1 x y n )))
(constraint (=> (inv i x y n ) (= x 0)))
(constraint (=> (and (inv i x y n ) (= i1 (+ i 1))) (inv i1 x y n )))
(constraint (=> (and (inv i x y n ) false) (not (= x 0))))
(check-synth)
