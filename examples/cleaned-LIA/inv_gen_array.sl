...
(constraint (=> (and (= s 5) (= 0 j)) (inv m j a0 )))
(constraint (=> (and6 (= j 0) (inv m j a0 ) (< j s) (= a0 t) (or (and (<= a0 m) (= m1 a0)) (and (> a0 m) (= m1 m))) (= j1 (+ j 1)) ) (inv m1 j1 a0 )))
(constraint (=> (and6 (= j 1) (inv m j a0 ) (< j s) (= a1 t) (or (and (<= a1 m) (= m1 a1)) (and (> a1 m) (= m1 m))) (= j1 (+ j 1)) ) (inv m1 j1 a0 )))
(constraint (=> (and6 (= j 2) (inv m j a0 ) (< j s) (= a2 t) (or (and (<= a2 m) (= m1 a2)) (and (> a2 m) (= m1 m))) (= j1 (+ j 1)) ) (inv m1 j1 a0 )))
(constraint (=> (and6 (= j 3) (inv m j a0 ) (< j s) (= a3 t) (or (and (<= a3 m) (= m1 a3)) (and (> a3 m) (= m1 m))) (= j1 (+ j 1)) ) (inv m1 j1 a0 )))
(constraint (=> (and6 (= j 4) (inv m j a0 ) (< j s) (= a4 t) (or (and (<= a4 m) (= m1 a4)) (and (> a4 m) (= m1 m))) (= j1 (+ j 1)) ) (inv m1 j1 a0 )))
(constraint (=> (and3 (= j 5) (inv m j a0 ) (>= j s) ) (>= a0 m)))
(check-synth)
