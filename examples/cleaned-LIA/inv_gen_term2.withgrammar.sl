...
(constraint (=> (and (< x 100) (< z 100)) (inv x y z )))
(constraint (=> (and5 (inv x y z ) (< x 100) (< 100 z) (=> t (and (= x1 (+ x 1)) (= z1 z))) (=> (not t) (and (= x1 (- x 1)) (= z1 (- z 1)))) ) (inv x1 y z1 )))
(constraint (=> (and (inv x y z ) (not (and (< x 100) (< 100 z)))) (or (>= x 100) (<= z 100))))
(check-synth)
