...
(constraint (=> (and (= x 0) (> n 0)) (inv x n )))
(constraint (=> (and false (inv x n )) (= x n)))
(constraint (=> (inv x n ) (inv x n )))
(constraint (=> (and3 (inv x n ) (= x1 (+ x 1)) (< x1 n) ) (inv x1 n )))
(constraint (=> (and3 (inv x n ) (= x1 (+ x 1)) (>= x1 n) ) (= x1 n)))
(check-synth)
