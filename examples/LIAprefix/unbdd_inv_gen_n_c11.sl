...
(synth-fun __SYNTHFUN_inv((i Int)(l Int)) Bool
...
(constraint (=> (= l 0) (__SYNTHFUN_inv i l )))
(constraint (=> (and5 (__SYNTHFUN_inv i l ) (=> (= l 4) (= l1 0)) (=> (not (= l 4)) (= l1 l)) (not (or (< l1 0) (>= l1 5))) (= l2 (+ l1 1)) ) (__SYNTHFUN_inv i l2 )))
(constraint (=> (and4 (__SYNTHFUN_inv i l ) (=> (= l 4) (= l1 0)) (=> (not (= l 4)) (= l1 l)) (or (< l1 0) (>= l1 5)) ) false))
(check-synth)
