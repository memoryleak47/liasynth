...
(synth-fun __SYNTHFUN_eq1((x Int)(y Int)) Int
...
(constraint (ite (<= (plus2 x y ) 1) (= (__SYNTHFUN_eq1 x y ) (ten-times (plus3 x y 1 ) )) (ite (<= (plus2 x y ) 2) (= (__SYNTHFUN_eq1 x y ) (ten-times (two-times (plus3 x y (- 1) ) ) )) (ite (<= (plus2 x y ) 3) (= (__SYNTHFUN_eq1 x y ) (ten-times (three-times (plus3 x y 1 ) ) )) (ite (<= (plus2 x y ) 4) (= (__SYNTHFUN_eq1 x y ) (ten-times (four-times (plus3 x y (- 1) ) ) )) (ite (<= (plus2 x y ) 5) (= (__SYNTHFUN_eq1 x y ) (ten-times (five-times (plus3 x y 1 ) ) )) (= (__SYNTHFUN_eq1 x y ) (ten-times (six-times (plus3 x y (- 1) ) ) ))))))))
(check-synth)
