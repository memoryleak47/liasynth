...
(synth-fun __SYNTHFUN_ex((x Int)(y Int)) Int
...
(constraint (iteB (>= x 5) (= (__SYNTHFUN_ex x y ) (plus3 (five-times x ) (three-times y ) 17 )) (= (__SYNTHFUN_ex x y ) (plus2 (three-times x ) 1 )) ))
(check-synth)
