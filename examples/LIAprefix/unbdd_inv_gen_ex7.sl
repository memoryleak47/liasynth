...
(synth-fun __SYNTHFUN_inv((i Int)(y Int)(l Int)) Bool
...
(constraint (=> (and3 (not (or3 (< x 0) (< y 0) (> y x) )) (= l x) (= i 0) ) (__SYNTHFUN_inv i y l )))
(constraint (=> (and4 (__SYNTHFUN_inv i y l ) (< i y) (not (or (< i 0) (>= i l))) (= i1 (+ i 1)) ) (__SYNTHFUN_inv i1 y l )))
(constraint (=> (and3 (__SYNTHFUN_inv i y l ) (< i y) (or (< i 0) (>= i l)) ) false))
(check-synth)
