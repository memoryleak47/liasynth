...
(constraint (=> (and4 (>= x 0) (<= x 2) (>= y 0) (<= y 2) ) (__SYNTHFUN_inv x y )))
(constraint (=> (and3 (__SYNTHFUN_inv x y ) (= x1 (+ x 2)) (= y1 (+ y 2)) ) (__SYNTHFUN_inv x1 y1 )))
(constraint (=> (__SYNTHFUN_inv x y ) (not (and (= x 4) (= y 0)))))
(check-synth)
