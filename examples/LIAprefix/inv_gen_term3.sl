...
(constraint (=> (<= y 0) (or (<= y 0) (and (> y 0) (>= x 100)))))
(constraint (=> (> y 0) (__SYNTHFUN_inv x y )))
(constraint (=> (and3 (__SYNTHFUN_inv x y ) (< x 100) (= x1 (+ x y)) ) (__SYNTHFUN_inv x1 y )))
(constraint (=> (and (__SYNTHFUN_inv x y ) (not (< x 100))) (or (<= y 0) (and (> y 0) (>= x 100)))))
(check-synth)
