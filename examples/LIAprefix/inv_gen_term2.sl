...
(synth-fun __SYNTHFUN_inv((x Int)(y Int)(z Int)) Bool
...
(constraint (=> (and (< x 100) (< z 100)) (__SYNTHFUN_inv x y z )))
(constraint (=> (and5 (__SYNTHFUN_inv x y z ) (< x 100) (< 100 z) (=> t (and (= x1 (+ x 1)) (= z1 z))) (=> (not t) (and (= x1 (- x 1)) (= z1 (- z 1)))) ) (__SYNTHFUN_inv x1 y z1 )))
(constraint (=> (and (__SYNTHFUN_inv x y z ) (not (and (< x 100) (< 100 z)))) (or (>= x 100) (<= z 100))))
(check-synth)
