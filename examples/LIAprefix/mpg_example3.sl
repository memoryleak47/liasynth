...
(constraint (iteB (>= (three-times z ) 5) (iteB (<= (two-times x ) y) (= (__SYNTHFUN_eq2 x y z ) (plus4 (three-times x ) (minus (five-times y ) ) (seven-times z ) 9 )) (= (__SYNTHFUN_eq2 x y z ) (plus4 x x (minus (nine-times z ) ) 5 )) ) (iteB (<= (two-times z ) (plus3 (minus y ) x x )) (= (__SYNTHFUN_eq2 x y z ) (plus3 (minus (six-times x ) ) (three-times y ) 4 )) (= (__SYNTHFUN_eq2 x y z ) (plus3 (nine-times (plus2 x y ) ) (minus z ) 5 )) ) ))
(check-synth)
