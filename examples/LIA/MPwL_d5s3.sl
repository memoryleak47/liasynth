...
(declare-var v4 Int)
(declare-var v5 Int)
(constraint (=> (= v5 (move (interpret-move (interpret-move 0 v0) v1) o0-2 o1-2)) (=> (= v4 (move (interpret-move 0 v0) o0-1 o1-1)) (=> (= v3 (move 0 99 98)) (=> (= v2 (move (interpret-move (interpret-move 0 v0) v1) o0-2 o1-2)) (=> (= v1 (move (interpret-move 0 v0) o0-1 o1-1)) (=> (= v0 (move 0 99 98)) (or (and (= (interpret-move (interpret-move (interpret-move 0 v0) v1) v2) 11) (and (no-overlaps-one-step 0 v3 99 o0-1 98 o1-1) (and (no-overlaps-one-step (interpret-move 0 v0) v4 o0-1 o0-2 o1-1 o1-2) (and (no-overlaps-one-step (interpret-move (interpret-move 0 v0) v1) v5 o0-2 o0-3 o1-2 o1-3) true)))) (not (and (allowable-move-obstacle-0 99 o0-1) (and (allowable-move-obstacle-0 o0-1 o0-2) (and (allowable-move-obstacle-0 o0-2 o0-3) (and (allowable-move-obstacle-1 98 o1-1) (and (allowable-move-obstacle-1 o1-1 o1-2) (and (allowable-move-obstacle-1 o1-2 o1-3) true)))))))))))))))
