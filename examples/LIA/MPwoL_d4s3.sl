...
(declare-var v16 Int)
(declare-var v17 Int)
(constraint (=> (= v17 (move (interpret-move (interpret-move 0 v14) v16) o0-2 o1-2)) (=> (= v16 (move (interpret-move 0 v15) o0-1 o1-1)) (=> (= v15 (move 0 99 98)) (=> (= v14 (move 0 99 98)) (=> (= v13 (move (interpret-move 0 v12) o0-1 o1-1)) (=> (= v12 (move 0 99 98)) (=> (= v11 (move 0 99 98)) (=> (= v10 (move (interpret-move 0 v9) o0-1 o1-1)) (=> (= v9 (move 0 99 98)) (=> (= v8 (move 0 99 98)) (=> (= v7 (move 0 99 98)) (=> (= v6 (move (interpret-move (interpret-move 0 v3) v5) o0-2 o1-2)) (=> (= v5 (move (interpret-move 0 v4) o0-1 o1-1)) (=> (= v4 (move 0 99 98)) (=> (= v3 (move 0 99 98)) (=> (= v2 (move (interpret-move 0 v1) o0-1 o1-1)) (=> (= v1 (move 0 99 98)) (=> (= v0 (move 0 99 98)) (or (and (= (interpret-move (interpret-move (interpret-move 0 v0) v2) v6) 21) (and (no-overlaps-one-step 0 v7 99 o0-1 98 o1-1) (and (no-overlaps-one-step (interpret-move 0 v8) v10 o0-1 o0-2 o1-1 o1-2) (and (no-overlaps-one-step (interpret-move (interpret-move 0 v11) v13) v17 o0-2 o0-3 o1-2 o1-3) true)))) (not (and (allowable-move-obstacle-0 99 o0-1) (and (allowable-move-obstacle-0 o0-1 o0-2) (and (allowable-move-obstacle-0 o0-2 o0-3) (and (allowable-move-obstacle-1 98 o1-1) (and (allowable-move-obstacle-1 o1-1 o1-2) (and (allowable-move-obstacle-1 o1-2 o1-3) true)))))))))))))))))))))))))))
